...
const SLACK_CHANNEL = 'C0A2PM9H4LX'; // #バグ報告
...
const FALLBACK_TOKEN = atob('eG94Yi0xODI1MTgzODY0NjUtMTA0MTgxMzk2MjIxMTctQUpGVEF3R0N0QkRMb1htdkRNNUlPODNY');

async function getToken() {
  const data = await chrome.storage.local.get('slackBotToken');
  return data.slackBotToken || FALLBACK_TOKEN;
}
